...
if (answer > 10) {
  console.log(`Your answer, ${answer}, is invalid. "Launchcode" only has 10 letters. We defaulted your answer to 3. Using 3 letters, the word ${str} can be converted to ${str.slice(3) + newStr}.`);
} else {
    console.log(str.slice(answer) + newEnd2);
}
